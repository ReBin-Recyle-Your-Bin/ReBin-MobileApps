...
class CraftPagingSource(private val apiService: ApiService) : PagingSource<Int, CraftPagingItems>() {

    private companion object {
        const val INITIAL_PAGE_INDEX = 1
    }

    override fun getRefreshKey(state: PagingState<Int, CraftPagingItems>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, CraftPagingItems> {
        return try {
